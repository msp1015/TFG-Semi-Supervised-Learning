...
% Datos de portada
\title{ Ampliación de web para la docencia de métodos de aprendizaje semi-supervisado}
\author{\nombre}
\tutor{\Tutor}
\date{\today}
...
\noindent Que el alumno D. \nombre, con DNI 71482918E, ha realizado el Trabajo final de Grado en Ingeniería Informática titulado <<Ampliación de web para la docencia de métodos de aprendizaje semi-supervisado>>. 
...
\begin{abstract}
machine learning, semisupervised learning, ensembles, graphs, algorithms, web page
\end{abstract}
