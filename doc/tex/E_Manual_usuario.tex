...
\imagen{anexos/manual-usuario/Visualizacion principal}{Visualización principal}{Visualización principal}{1}
...
\imagen{anexos/manual-usuario/tooltips/CF-ClasificadosFinal}{\textit{Tooltip} de ejecución final del Co-Forest}{\textit{Tooltip} del Co-Forest}{0.3}
...
\imagen{anexos/manual-usuario/especificasCoForest}{Estadísticas específicas en \textit{Co-Forest}}{\textit{Co-Forest}: estadísticas específicas}{1}
...
\imagen{anexos/manual-usuario/Visualizacion principal grafos}{Página de visualización de grafos}{Visualización general de grafos}{1}
...
\imagen{anexos/manual-usuario/controlesGrafos}{Controles para grafos}{Controles de grafos}{0.5}
...
\imagen{anexos/manual-usuario/visualizacion grafos}{Visualización principal del grafo}{Visualización de un grafo}{1}
...
\imagen{anexos/manual-usuario/nodo seleccionado dos pasos}{Nodo seleccionado en dos fases seguidas del algoritmo}{Nodo seleccionado en grafo}{0.5}
...
\imagen{anexos/manual-usuario/transicion inferencia}{Instante de inferencia sobre los nodos}{Instantánea de fase de inferencia en nodos}{0.8}
...
\imagen{anexos/manual-usuario/leyenda grafos}{Datos iniciales de una clase}{Grafos: datos iniciales de una clase}{0.8}
...
\imagen{anexos/manual-usuario/resultados inferencia general}{Resultados de inferencia en grafos}{Resultados de inferencia en grafos}{0.8}
...
\imagen{anexos/manual-usuario/resultados inferencia clase}{Resultados de inferencia de una clase concreta}{Resultados de inferencia en grafos en clase concreta}{0.8}
...
\imagen{anexos/manual-usuario/Registrarse - VASS}{Formulario de registro}{Formulario de Registro}{0.5}
...
\imagen{anexos/manual-usuario/Iniciar sesión - VASS}{Formulario de inicio de sesión}{Formulario de inicio de sesión}{0.5}
...
\imagen{anexos/manual-usuario/EliminarRun - VASS}{Eliminar ejecución}{Eliminar ejecución}{0.6}
