...
function updateGraph() {
    ...
    if (currentStep === dataSteps.length - 1 && !document.getElementById('infer')) {
      ...
      inferButton.id = 'infer';
      inferButton.textContent = 'Inferir etiquetas';
      inferButton.addEventListener('click', inferLabels);
      document.body.appendChild(inferButton);
    }
